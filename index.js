...
/***/ function(module, exports, __webpack_require__) {
	...
	var render = function render() {
	    ...
	    _reactDom2.default.render(_react2.default.createElement(_containers2.default, { data: data }), document.getElementById("app"));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialStoreObj = [{ className: "matrixC", matrix: [['', '', '', ''], ['', '', '', '']], name: "c", activeMatrix: "", status: "", description: "" }, { className: "matrixA", matrix: [['1', '2', '3'], ['1', '1', '1']], name: "a" }, { className: "matrixB", matrix: [['2', '3', '4', '5'], ['6', '6', '6', '6'], ['7', '7', '7', '7']], name: "b" }];

	var store = (0, _redux.createStore)(_reducers2.default, initialStoreObj);
...
/***/ function(module, exports) {
	...
	exports.__esModule = true;
	exports.default = matrixReducers;
	if (!Object.assign) {
	...
	function matrixReducers() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? initialStoreObj : arguments[0];
	    ...
	    function retunValueAfterAddRemove(index, updatedMatrix) {
	        ...
	        var status = "";
	        if (index === 1) {
	            var matrixCUpdate = addColumnsRowsToResultMatrix(updatedMatrix, state[2].matrix);
	        ...
	        if (index === 2) {
	            var _matrixCUpdate = addColumnsRowsToResultMatrix(state[1].matrix, updatedMatrix);
	            return [].concat(Object.assign({}, state[0], {
	                matrix: _matrixCUpdate
	            }, {
	                status: status
	            }, {
	                description: description
	    ...
	    switch (action.type) {
	        ...
	        case "MULTIPLY":
	            {
	                var objectToReturn = state.slice();
	                var matrixA = action.matrixA;
	                var matrixB = action.matrixB;
	                var resultMatrix = [];
	                var _status = "";
	                var _description = "";
	                        ...
	                        if (checkMatrixData(matrixA) && checkMatrixData(matrixB)) {
	                            for (var row = 0; row < matrixA.length; row++) {
	                                ...
	                                while (matrixBSize < matrixB.length * matrixB[0].length) {
	                                    resSum += matrixA[row][_key] * matrixB[_key][matrixBCol];
	                                    _key++;
	                                    matrixBSize++;
	                                    if (_key > matrixA.length) {
	                                        _key = 0;
	                            ...
	                            _status = "fail";
	                            _description = "Матрицы должны быть заполнены положительными числами больше 0.";
	                        }
	                    } else {
	                        _status = "fail";
	                        _description = "Такие матрицы нельзя перемножить так как количество столбцов матрицы А не равно количеству строк матриц В.";
	                    }
	                } else {
	                    _status = "fail";
	                    _description = "Матрицы не определены";
	                }
	                objectToReturn[0] = Object.assign({}, state[0], {
	                    status: _status
	                }, {
	        ...
	        case "UPDATE":
	            {
	                var _status2 = "edit";
	                var _description2 = "";
	                var objToReturn = retunValueAfterAddRemove(action.index, action.matrix).slice();
	        ...
	        case "CLEAN":
	            {
	                var _objToReturn = state.slice();
	                var updatedMatrix = [];
	                var _description3 = "";
	                var _status3 = "";
	                for (var index = 0; index < state.length; index++) {
	                    var matrix = state[index].matrix.slice();
	                    for (var _row = 0; _row < matrix.length; _row++) {
	                        var matrixRow = matrix[_row];
	                        for (var _col = 0; _col < matrixRow.length; _col++) {
	                            matrixRow[_col] = '';
	                        }
	                    }
	                    if (index === 0) {
	                        _objToReturn[index] = Object.assign({}, state[index], {
	                            matrix: matrix
	                        }, {
	                            status: _status3
	                        }, {
	        ...
	        case "INTERCHANGE":
	            {
	                ...
	                for (var key = 0; key < state.length; key++) {
	                    _objToReturn2.push(Object.assign({}, state[key], {
	                        matrix: []
	                    }));
	                }
	                var mC = addColumnsRowsToResultMatrix(action.matrixB, action.matrixA);
	                Object.assign(_objToReturn2[0], state[0], {
	                    matrix: mC
	                }, {
	                    status: _status4
	                }, {
	                ...
	                Object.assign(_objToReturn2[1], {
	                    matrix: action.matrixB
	                });
	                Object.assign(_objToReturn2[2], {
	                    matrix: action.matrixA
	                });
	                return _objToReturn2;
	            }

	        case "ADD_ROW":
	            {
	                var _index = action.matrixIndex;
	                var matrixToChange = state[_index].matrix.slice();
	                var addElementArray = [''];

	                if (matrixToChange.length < 10) {
	                    if (matrixToChange.length > 0) {
	                        for (var k = 0; k < matrixToChange[0].length - 1; k++) {
	                            addElementArray.push('');
	                        }
	                    }
	                    matrixToChange.push(addElementArray);
	                    return retunValueAfterAddRemove(_index, matrixToChange);
	                }
	        ...
	        case "ADD_COLUMN":
	            {
	                var _index2 = action.matrixIndex;
	                var _matrixToChange = state[_index2].matrix.slice();

	                if (_matrixToChange.length > 0 && _matrixToChange[0].length < 10) {
	                    for (var _row2 = 0; _row2 < _matrixToChange.length; _row2++) {
	                        _matrixToChange[_row2].push('');
	                    }
	                    return retunValueAfterAddRemove(_index2, _matrixToChange);
	                }
	                if (_matrixToChange.length === 0) {
	                    _matrixToChange.push(['']);
	                    return retunValueAfterAddRemove(_index2, _matrixToChange);
	                }
	        ...
	        case "REMOVE_ROW":
	            {
	                var _index3 = action.matrixIndex;
	                var _matrixToChange2 = state[action.matrixIndex].matrix.slice();
	                var changeArray = [];

	                if (_matrixToChange2.length > 0) {
	                    _matrixToChange2.pop();
	                    return retunValueAfterAddRemove(_index3, _matrixToChange2);
	                }
	        ...
	        case "REMOVE_COLUMN":
	            {
	                var _index4 = action.matrixIndex;
	                var _matrixToChange3 = state[action.matrixIndex].matrix.slice();

	                if (_matrixToChange3.length > 0) {
	                    for (var _row3 = 0; _row3 < _matrixToChange3.length; _row3++) {
	                        _matrixToChange3[_row3].pop();
	                    }
	                    if (_matrixToChange3[0].length === 0) {
	                        _matrixToChange3.length = 0;
	                    }
	                    return retunValueAfterAddRemove(_index4, _matrixToChange3);
	                }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _controlPanel = __webpack_require__(184);

	var _controlPanel2 = _interopRequireDefault(_controlPanel);

	var _matrixContainer = __webpack_require__(189);

	var _matrixContainer2 = _interopRequireDefault(_matrixContainer);

	var _handlers = __webpack_require__(190);
	...
	var MainContainer = function (_React$Component) {
	    ...
	    function MainContainer(props) {
	        ...
	        _this.removeCol = _this.removeCol.bind(_this);
	        _this.setActiveMatrix = _this.setActiveMatrix.bind(_this);
	        return _this;
	    }

	    MainContainer.prototype.update = function update(e) {
	        var data = (0, _handlers.updateMatrixValues)(e);
	        this.setState({ data: data });
	    };

	    MainContainer.prototype.change = function change(e) {
	        var data = (0, _handlers.onIntrchangePlace)();
	        this.setState({ data: data });
	    };

	    MainContainer.prototype.clear = function clear(e) {
	        var data = (0, _handlers.onClearMatrix)();
	        this.setState({ data: data });
	    };

	    MainContainer.prototype.multiply = function multiply(e) {
	        var data = (0, _handlers.onMul)();
	        this.setState({ data: data });
	    };

	    MainContainer.prototype.addRow = function addRow() {
	        var data = (0, _handlers.onAddRow)();
	        this.setState({ data: data });
	    };

	    MainContainer.prototype.removeCol = function removeCol() {
	        var data = (0, _handlers.onRemoveColumn)();
	        this.setState({ data: data });
	    };

	    MainContainer.prototype.addCol = function addCol() {
	        var data = (0, _handlers.onAddColumn)();
	        this.setState({ data: data });
	    };

	    MainContainer.prototype.removeRow = function removeRow() {
	        var data = (0, _handlers.onRemoveRow)();
	        this.setState({ data: data });
	    };

	    MainContainer.prototype.setActiveMatrix = function setActiveMatrix(e) {
	        var data = (0, _handlers.onChangeActiveMatrix)(e);
	        this.setState({ data: data });
	    };
	    ...
	    MainContainer.prototype.render = function render() {
	        return _react2.default.createElement(
	            'div',
	            null,
	            _react2.default.createElement(_controlPanel2.default, { clear: this.clear, change: this.change, multiply: this.multiply, addRow: this.addRow, addCol: this.addCol, removeRow: this.removeRow, removeCol: this.removeCol, setActiveMatrix: this.setActiveMatrix, data: this.props.data }),
	            _react2.default.createElement(_matrixContainer2.default, { data: this.state.data, update: this.update })
	        );
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cleanUrl = __webpack_require__(185);
	var vvUrl = __webpack_require__(186);
	var minusUrl = __webpack_require__(187);
	var plusUrl = __webpack_require__(188);

	var ControlsPanel = function (_React$Component) {
	    ...
	    ControlsPanel.prototype.render = function render() {
	        var status = this.props.data[0].status;
	        var prompt = this.props.data[0].description;
	        var activeMatrix = this.props.data[0].activeMatrix;
	        return _react2.default.createElement(
	            'div',
	            { className: "controlsPanel " + (status === "edit" ? "controlsPanelEdit " : "") + (status === "fail" ? "controlsPanelErr" : "") },
	            _react2.default.createElement(
	                'div',
	                { id: 'mulContainer' },
	                _react2.default.createElement(
	                    'div',
	                    { id: 'mulButtonPart1', onClick: this.props.multiply },
	                    _react2.default.createElement(
	                        'span',
	                        null,
	                        'Multiply matrixes'
	                ...
	                _react2.default.createElement('div', { id: 'mulButtonPart2' })
	            ),
	            _react2.default.createElement(
	                'div',
	                { id: 'matrixOp' },
	                _react2.default.createElement(
	                    'button',
	                    { id: 'clearMatrix', onClick: this.props.clear },
	                    _react2.default.createElement('img', { id: 'cleanImg', src: cleanUrl }),
	                    'Clear matrixes'
	                ),
	                _react2.default.createElement('br', null),
	                _react2.default.createElement(
	                    'button',
	                    { id: 'viceVersa', onClick: this.props.change },
	                    _react2.default.createElement('img', { id: 'viceVersaImg', src: vvUrl }),
	                    'Interchange matrixes'
	                ),
	                _react2.default.createElement('br', null),
	                _react2.default.createElement(
	                    'label',
	                    { id: 'labelRadioA' },
	                    _react2.default.createElement('input', { type: 'radio', id: 'radioMatrixA', value: 'matrixA', name: 'matrix', onClick: this.props.setActiveMatrix }),
	                    ' Matrix А'
	                ),
	                _react2.default.createElement(
	                    'label',
	                    { id: 'labelRadioB' },
	                    _react2.default.createElement('input', { type: 'radio', id: 'radioMatrixB', value: 'matrixB', name: 'matrix', onClick: this.props.setActiveMatrix }),
	                    ' Matrix B'
	                ),
	                _react2.default.createElement('br', null),
	                _react2.default.createElement(
	                    'button',
	                    { id: 'addRow', onClick: this.props.addRow, disabled: activeMatrix ? false : true },
	                    _react2.default.createElement('img', { id: 'addRowImg', src: plusUrl }),
	                    'Add'
	                ),
	                _react2.default.createElement(
	                    'button',
	                    { id: 'removeRow', onClick: this.props.removeRow, disabled: activeMatrix ? false : true },
	                    _react2.default.createElement('img', { id: 'minusRowImg', src: minusUrl }),
	                    'Remove'
	                ),
	                'строку ',
	                _react2.default.createElement('br', null),
	                _react2.default.createElement(
	                    'button',
	                    { id: 'addColumn', onClick: this.props.addCol, disabled: activeMatrix ? false : true },
	                    _react2.default.createElement('img', { id: 'addColImg', src: plusUrl }),
	                    'Add'
	                ),
	                _react2.default.createElement(
	                    'button',
	                    { id: 'removeColumn', onClick: this.props.removeCol, disabled: activeMatrix ? false : true },
	                    _react2.default.createElement('img', { id: 'minusColImg', src: minusUrl }),
	                    'Remove'
	                ),
	                'столбец',
	                _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "src/pics/clean.png";

/***/ },
/* 186 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "src/pics/viceversa.png";

/***/ },
/* 187 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "src/pics/minus.png";

/***/ },
/* 188 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "src/pics/plus.png";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MatrixCell = function (_React$Component) {
	    ...
	    MatrixCell.prototype.render = function render() {
	        var rowN = this.props.row + 1;
	        var name = this.props.name;
	        var mClassName = this.props.className;
	        var update = this.props.update;
	        var rows = this.props.data.map(function (elem, index) {
	            var position = name + rowN + "," + ++index;
	            return _react2.default.createElement("input", { key: index, type: "text", id: position, placeholder: position, value: elem || elem === 0 ? elem : "", disabled: mClassName === "matrixC" ? true : false, onChange: update });
	        });
	        return _react2.default.createElement(
	            "div",
	            null,
	...
	var MatrixRow = function (_React$Component2) {
	    ...
	    MatrixRow.prototype.render = function render() {
	        var className = this.props.data.className;
	        var name = this.props.data.name;
	        var update = this.props.update;
	        var elementsRows = this.props.data.matrix.map(function (element, index) {
	            return _react2.default.createElement(MatrixCell, { key: index, data: element, row: index, name: name, className: className, update: update });
	        });
	        return _react2.default.createElement(
	            "div",
	            { className: className },
	...
	var MatrixContainer = function (_React$Component3) {
	    _inherits(MatrixContainer, _React$Component3);
	    ...
	    MatrixContainer.prototype.render = function render() {
	        var matrixC = this.props.data[0];
	        var matrixA = this.props.data[1];
	        var matrixB = this.props.data[2];
	        return _react2.default.createElement(
	            "div",
	            { className: "matrixContainer" },
	            _react2.default.createElement(MatrixRow, { data: matrixC }),
	            _react2.default.createElement(
	                "div",
	                { id: "matrixAContainer" },
	                _react2.default.createElement(MatrixRow, { data: matrixA, update: this.props.update }),
	                _react2.default.createElement(
	                    "span",
	                    null,
	                    "A"
	            ...
	            _react2.default.createElement(
	                "div",
	                { id: "matrixBContainer" },
	                _react2.default.createElement(MatrixRow, { data: matrixB, update: this.props.update }),
	                _react2.default.createElement(
	                    "span",
	                    null,
	                    "B"
	...
	exports.default = MatrixContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.__esModule = true;
	exports.onMul = onMul;
	exports.onClearMatrix = onClearMatrix;
	exports.onChangeActiveMatrix = onChangeActiveMatrix;
	exports.onIntrchangePlace = onIntrchangePlace;
	exports.onAddRow = onAddRow;
	exports.onRemoveRow = onRemoveRow;
	exports.onRemoveColumn = onRemoveColumn;
	exports.onAddColumn = onAddColumn;
	exports.updateMatrixValues = updateMatrixValues;
	...
	function choosingMatrixToChange(func) {
	    var matrixC = _store2.default.getState()[0];
	    if (matrixC.activeMatrix === "matrixA") {
	        _store2.default.dispatch(func(1));
	    }
	    if (matrixC.activeMatrix === "matrixB") {
	        _store2.default.dispatch(func(2));
	    }
	}

	function onMul() {
	    var matrixA = _store2.default.getState()[1].matrix;
	    var matrixB = _store2.default.getState()[2].matrix;
	    _store2.default.dispatch((0, _actions.multiply)(matrixA, matrixB));
	    return _store2.default.getState();
	}

	function onClearMatrix() {
	    _store2.default.dispatch((0, _actions.cleanMatrix)());
	    return _store2.default.getState();
	}

	function onChangeActiveMatrix(e) {
	    _store2.default.dispatch((0, _actions.swicthRadioMatrix)(e.target.value));
	    return _store2.default.getState();
	}

	function onIntrchangePlace() {
	    var matrixA = _store2.default.getState()[1].matrix;
	    var matrixB = _store2.default.getState()[2].matrix;
	    _store2.default.dispatch((0, _actions.interchangePlace)(matrixA, matrixB));
	    return _store2.default.getState();
	}

	function onAddRow() {
	    choosingMatrixToChange(_actions.addRow);
	    return _store2.default.getState();
	}

	function onRemoveRow() {
	    choosingMatrixToChange(_actions.removeRow);
	    return _store2.default.getState();
	}

	function onRemoveColumn() {
	    choosingMatrixToChange(_actions.removeColumn);
	    return _store2.default.getState();
	}

	function onAddColumn() {
	    choosingMatrixToChange(_actions.addColumn);
	    return _store2.default.getState();
	}

	function updateMatrixValues(e) {
	    var placeWithNewData = e.target.id;
	    var re = /a/;
	    var index = re.test(placeWithNewData) ? 1 : 2;
	    var row = placeWithNewData.slice(1, placeWithNewData.indexOf(",")) - 1;
	    var col = placeWithNewData.slice(placeWithNewData.indexOf(",") + 1) - 1;
	    var matrix = _store2.default.getState()[index].matrix.slice();
	    matrix[row][col] = e.target.value;
	    _store2.default.dispatch((0, _actions.updateMatrix)(matrix, index));
	    return _store2.default.getState();
	}
...
/***/ function(module, exports) {
	...
	exports.interchangePlace = interchangePlace;
	exports.swicthRadioMatrix = swicthRadioMatrix;
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, ".mixInlineFloat {\n  display: inline-block;\n  float: left;\n}\n.mixMatrixContainerAbsolut {\n  content: \" \";\n  position: absolute;\n  height: 2px;\n  left: 10px;\n  right: 10px;\n  background: #ffffff;\n}\nbody {\n  font-family: 'Segoe UI';\n}\n.controlsPanel {\n  width: 350px;\n  height: 100vh;\n  background: #bcbcbc;\n  font-size: 14px;\n  line-height: 20px;\n  display: inline-block;\n  float: left;\n}\n.controlsPanelEdit {\n  background: #5199db;\n}\n.controlsPanelErr {\n  background: #f6c1c0;\n}\n.controlsPanelErr p {\n  color: #e04541;\n  margin-top: 50px;\n}\n#matrixOp {\n  margin-left: 30px;\n}\n#mulContainer {\n  height: 40px;\n  margin-left: 30px;\n  margin-top: 30px;\n  margin-bottom: 45px;\n}\n#mulContainer #mulButtonPart1 {\n  display: inline-block;\n  float: left;\n  background: #49a61b;\n  color: #ffffff;\n  border-radius: 2px;\n  padding: 10px 15px;\n  font-size: 16px;\n  border: 1px solid rgba(54, 122, 20, 0.5);\n  border-right: 0;\n}\n#mulContainer #mulButtonPart2 {\n  display: inline-block;\n  float: left;\n  width: 0;\n  height: 0;\n  border-top: 20px solid transparent;\n  border-left: 10px solid #49a61b;\n  border-bottom: 20px solid transparent;\n}\n#viceVersa {\n  margin-bottom: 50px;\n}\n#addRow,\n#removeRow,\n#clearMatrix {\n  margin-bottom: 10px;\n}\n#addRow,\n#addColumn,\n#removeRow,\n#removeColumn,\nlabel {\n  margin-right: 10px;\n}\n#radioMatrixA,\n#radioMatrixB {\n  margin-bottom: 15px;\n}\nbutton {\n  font-family: 'Segoe UI';\n  font-size: 14px;\n  line-height: 25px;\n  background: #f4f4f4;\n  background-image: linear-gradient(to bottom, #ffffff, #ededed);\n  border: 1px solid rgba(90, 90, 90, 0.5);\n}\nbutton:hover {\n  background: #e8e8e8;\n  background-image: linear-gradient(to bottom, #f1f1f1, #dfdfdf);\n}\nbutton:active {\n  background: #d9d9d9;\n  outline: none;\n}\nbutton:disabled {\n  background: #f2f2f2;\n}\nbutton:focus {\n  outline: 2px solid #5199db;\n}\nimg {\n  vertical-align: text-bottom;\n}\n.matrixContainer {\n  display: inline-block;\n  float: left;\n}\ninput[type=text] {\n  width: 40px;\n  height: 40px;\n  box-sizing: border-box;\n  text-align: center;\n  margin: 5px;\n  padding-top: 15px;\n  border: 1px solid rgba(90, 90, 90, 0.5);\n}\n.matrixC,\n.matrixA,\n.matrixB {\n  border: 2px solid #404040;\n  position: relative;\n  padding: 5px;\n}\n.matrixC {\n  display: inline-block;\n  float: left;\n  margin-top: 25px;\n  margin-bottom: 25px;\n}\n.matrixA {\n  display: inline-block;\n  float: left;\n}\n.matrixB {\n  clear: both;\n  display: inline-block;\n}\n#matrixAContainer {\n  display: inline-block;\n  float: left;\n  margin-left: 25px;\n  margin-top: 25px;\n  position: relative;\n}\n#matrixAContainer span,\n#matrixBContainer span {\n  font-size: 24px;\n}\n#matrixAContainer span {\n  position: absolute;\n  top: 35%;\n  margin-left: 10px;\n}\n#matrixBContainer span {\n  display: block;\n  text-align: center;\n  margin-top: 10px;\n}\n#matrixBContainer {\n  clear: both;\n  position: relative;\n  display: inline-block;\n  float: left;\n}\n#matrixBContainer,\n.matrixC {\n  margin-left: 25px;\n}\n.matrixC::before,\n.matrixA::before,\n.matrixB::before {\n  content: \" \";\n  position: absolute;\n  height: 2px;\n  left: 10px;\n  right: 10px;\n  background: #ffffff;\n  top: -2px;\n}\n.matrixC::after,\n.matrixA::after,\n.matrixB::after {\n  content: \" \";\n  position: absolute;\n  height: 2px;\n  left: 10px;\n  right: 10px;\n  background: #ffffff;\n  bottom: -2px;\n}\n", ""]);
